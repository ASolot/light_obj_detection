...
python train.py ctdet --exp_id visdrone_esp_c_1024 --batch_size 16 --arch espnetv2 --dataset visdrone --input_res 1024 --num_epochs 80 --lr_step 45,60 --gpus 0,1,2,3 --num_workers 32
