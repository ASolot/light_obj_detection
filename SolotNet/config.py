...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--multi-scale', action='store_true', 
    ...
    self.parser.add_argument('--mse_loss', action='store_true',
                             help='use mse loss or focal loss to train '
                                  'keypoint heatmaps.')
    self.parser.add_argument('--ce_loss', action='store_true',
                             help='use cross entropy loss or focal loss to train')
    # ctdet
    ...
    # yolov3
    self.parser.add_argument('--accumulate', type=int, default=1, help='accumulate gradient x batches before optimizing')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    #     opt.heads.update({'hp_offset': 2})
      ...
      #TODO: implement yolo related stuff
