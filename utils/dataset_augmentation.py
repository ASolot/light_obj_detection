...
DESTINATION = "/Images-cropped" + str(DESTINATION_WIDTH) + 'x' + str(DESTINATION_HEIGHT)
...
def main():
    ...
    image_crop_and_resize(SOURCE_TEST_DIRECTORY, DESTINATION_TEST_DIRECTORY)

    print ("Resizing Valid dataset\n\n")
    image_crop_and_resize(SOURCE_TRAIN_DIRECTORY, DESTINATION_TRAIN_DIRECTORY)
